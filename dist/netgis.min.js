...
$jscomp.polyfill("Number.isNaN",function(a){return a?a:function(a){return"number"===typeof a&&isNaN(a)}},"es6","es3");$jscomp.arrayIteratorImpl=function(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}};$jscomp.arrayIterator=function(a){return{next:$jscomp.arrayIteratorImpl(a)}};$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
...
$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,e=0;e<d;e++){var f=a[e];if(b.call(c,f,e,a))return{i:e,v:f}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6","es3");var netgis=netgis||{};netgis.Attribution=function(a){this.config=a;this.layers=this.client=null;this.items=[];this.initElements(a);this.initConfig(a)};netgis.Attribution.Config={prefix:"NetGIS"};
netgis.Attribution.prototype.initElements=function(a){this.container=document.createElement("section");this.container.className="netgis-attribution netgis-text-a";var b=this;window.setTimeout(function(){b.update()},100)};netgis.Attribution.prototype.initConfig=function(a){if(a&&(a.attribution&&a.attribution.prefix&&this.items.push(a.attribution.prefix),a=a.layers))for(var b=0;b<a.length;b++){var c=a[b],d=c.attribution;d&&0!==d.length&&c.active&&this.items.push(d)}};
...
netgis.Client.prototype.isMobile=function(){return netgis.util.isMobile(this.container)};netgis.Client.prototype.onConfigResponse=function(a){a=JSON.parse(a);this.init(this.container,a);this.showLoader(!1)};
netgis.Client.prototype.requestContextWMC=function(a,b){netgis.util.isDefined(this.config.wmc.legacy_mode)||(this.config.wmc.legacy_mode=!0);console.info("WMC LEGACY MODE:",this.config.wmc.legacy_mode);if(-1<a.indexOf("{id}"))if(b)a=netgis.util.replace(a,"{id}",b);else{console.warn("no wmc {id} set in config url",a);return}this.config.wmc.legacy_mode?(b=new netgis.WMCLegacy(this.config),b.requestContext(a,this.onContextResponseWMCLegacy.bind(this))):(b=new netgis.WMC(this.config),b.requestContext(a,
this.onContextResponseWMC.bind(this)));this.showLoader(!0)};
netgis.Client.prototype.onContextResponseWMCLegacy=function(a){console.info("CLIENT WMC RESPNSE:",a.output,"->",this.config);if(a&&a.output&&a.output.entities){var b=this.config&&this.config.wmc?this.config.wmc:null,c=b&&!0===b.layers_removable;(b=a.output.extent)&&this.modules.map.zoomExtent(b[0],b[1],b[2],b[3]);a=a.output.entities;var d={};for(b=0;b<a.length;b++){var e=a[b];if(e.layer&&e.title){for(var f=!1,g=0;g<a.length;g++){var h=a[g],k=h.parent?h.parent:null;if(k&&e===k){f=!0;break}}d[e.layer.id]=
f?this.modules.layertree.tree.addFolder(null,e.layer.id,e.title,!1):this.modules.layertree.addLayerItem({id:e.layer.id,title:e.title,query:!0===e.queryable,removable:c,transparency:e.opacity?1-.01*e.opacity:.2,active:!1},null)}}for(b=0;b<a.length;b++)e=a[b],e.layer&&e.title&&e.parent&&(k=e.parent?e.parent:null)&&!k.service&&this.modules.layertree.tree.setFolderParent(d[e.layer.id],d[k.layer.id]);this.modules.layertree.tree.moveItemDown(this.modules.layertree.tree.getFolder("bg"));this.modules.layertree.tree.moveButtonsDown();
for(b=0;b<a.length;b++)e=a[b],e.layer&&e.kml&&(c={id:e.layer.id.toString(),title:e.title,order:5E4,type:"KML",url:e.kml,opacity:e.opacity?e.opacity:.8,active:!1,query:!0},this.config.layers.push(c));for(b=0;b<a.length;b++)if(e=a[b],e.layer&&e.name){c=[];for(g=0;g<a.length;g++)a[g].parent===e&&c.push(a[g]);f=0<c.length;if(!1===f){h=e;c=e.url?e.url:null;do k=h.parent?h.parent:null,k.service&&(c=k.url),h=k;while(!c&&k);c={id:e.layer.id.toString(),title:e.title,order:a.length-b,type:"WMS",url:c,name:e.name,
opacity:e.opacity?e.opacity:.8,active:!1,query:!0===e.queryable};this.config.layers.push(c)}}for(b=0;b<a.length;b++)e=a[b],e.layer&&e.active&&netgis.util.invoke(this.container,netgis.Events.MAP_LAYER_TOGGLE,{id:e.layer.id.toString(),on:e.active});console.info("CONTEXT CONFIG:",this.config)}this.showLoader(!1)};
netgis.Client.prototype.onContextResponseWMC=function(a){console.info("WMC Response:",a);if(a&&a.config){for(var b=0;b<a.config.layers.length;b++)this.config.layers.push(a.config.layers[b]);a.config.map.bbox&&(this.config.map.bbox=a.config.map.bbox);netgis.util.invoke(this.container,netgis.Events.CLIENT_CONTEXT_RESPONSE,{context:a});this.modules.layertree&&this.modules.layertree.tree.reorderByAttribute("data-order",!0,!0)}this.showLoader(!1)};
netgis.Client.prototype.onContextResponseLayer=function(a){a=JSON.parse(a);var b=a.wms.srv;if(b&&0!==b.length)if(a=b[0],a.layer&&0<a.layer.length&&!0===a.layer[0].isRoot){b=a.layer[0];var c=b.getCapabilitiesUrl+"&withChilds=1",d=this.modules.import,e=this.modules.layertree,f="root_"+b.id,g=e.tree.addFolder(null,f,b.title,!0,!1,!0,!0,this.config.layertree.clip_titles);g.setAttribute("title",b["abstract"]);g.setAttribute("data-title",b.title);g.setAttribute("data-root-id",a.wmsRootLayerId);g.setAttribute("data-url",
c);e.tree.setFolderOpen(f,!0);netgis.util.request(c,function(a){this.onGeoportalFolderResponse(g,a,!0,e.tree)}.bind(d));if(a=a.bbox){a=a.split(",");for(b=0;b<a.length;b++)a[b]=Number.parseFloat(a[b]);netgis.util.invoke(this.container,netgis.Events.MAP_ZOOM_BBOX,{minlon:a[0],minlat:a[1],maxlon:a[2],maxlat:a[3]})}}else a=(new netgis.WMC).parseServiceLayer(a.id.toString(),a,null,a.layer[0],null),this.config.layers.push(a),netgis.util.invoke(this.container,netgis.Events.MAP_LAYER_CREATE,a),a.bbox&&netgis.util.invoke(this.container,
netgis.Events.MAP_ZOOM_BBOX,{minlon:a.bbox[0],minlat:a.bbox[1],maxlon:a.bbox[2],maxlat:a.bbox[3]});else console.error("no wmc service layer in context response",a)};netgis.Client.prototype.requestContextOWS=function(a){console.info("Request OWS:",a);netgis.util.request(a,this.onContextResponseOWS.bind(this))};netgis.Client.prototype.onContextResponseOWS=function(a){a=JSON.parse(a);console.info("OWS Response:",a);a=netgis.OWS.read(a,this);console.info("OWS Config:",a)};
netgis.Client.prototype.onMapEditLayerChange=function(a){a=JSON.stringify(a.detail.geojson);this.output.value=a};
...
netgis.Export.prototype.onExportEnd=function(a){this.modal.hide()};netgis=netgis||{};netgis.Geolocation=function(a){this.config=a;this.center=this.active=!1};netgis.Geolocation.Config={marker_color:"#3480eb",marker_title:"Geolocation",zoom:16,timeout:1E4};netgis.Geolocation.prototype.initConfig=function(a){};netgis.Geolocation.prototype.attachTo=function(a){this.container=a;a.addEventListener(netgis.Events.GEOLOCATION_TOGGLE_ACTIVE,this.onGeolocToggleActive.bind(this));a.addEventListener(netgis.Events.GEOLOCATION_TOGGLE_CENTER,this.onGeolocToggleCenter.bind(this))};
...
netgis.Geolocation.prototype.onCenterChange=function(a){};netgis.Geolocation.prototype.onPositionChange=function(a){netgis.util.invoke(this.container,netgis.Events.GEOLOCATION_CHANGE,{lon:a.coords.longitude,lat:a.coords.latitude,center:this.center,zoom:this.config.geolocation?this.config.geolocation.zoom:void 0})};netgis.Geolocation.prototype.onPositionError=function(a){this.error("Geolocation: "+a.message+" ("+a.code+")")};
netgis.Geolocation.prototype.onGeolocToggleActive=function(a){a.target!==this.container&&this.setActive(a.detail.on)};netgis.Geolocation.prototype.onGeolocToggleCenter=function(a){a.target!==this.container&&(this.center=a.detail.on)};netgis=netgis||{};netgis.Import=function(a){this.config=a;this.initElements(a);this.initSections(a);this.initPreview()};
netgis.Import.Config={title:"Import Layer",clip_titles:!1,preview:!0,editable:!0,wms_options:[],wfs_options:[],wfs_proxy:"",geopackage_lib:"/libs/geopackage/4.2.3/",geoportal_tab:!1,wms_tab:!0,wfs_tab:!0,geojson_tab:!0,gml_tab:!0,geopackage_tab:!0,spatialite_tab:!0,shapefile_tab:!0,geoportal_search_url:"",geoportal_search_dynamic:!0,geoportal_simplify_folders:!0,geoportal_import_hierarchy:!0,geoportal_order_reverse:!0,geoportal_order_by_meta:!1};
netgis.Import.prototype.initElements=function(a){a=a["import"];this.modal=new netgis.Modal(a.title?a.title:"Import");this.modal.container.classList.add("netgis-import");var b=[];!0===a.geoportal_tab&&b.push("Geoportal");!1!==a.wms_tab&&b.push("WMS");!1!==a.wfs_tab&&b.push("WFS");!1!==a.geojson_tab&&b.push("GeoJSON");!1!==a.gml_tab&&b.push("GML");!1!==a.geopackage_tab&&b.push("GeoPackage");!1!==a.spatialite_tab&&b.push("Spatialite");!1!==a.shapefile_tab&&b.push("Shapefile");this.tabs=new netgis.Tabs(b);
this.tabs.container.style.position="absolute";this.tabs.container.style.left="0mm";this.tabs.container.style.right="0mm";this.tabs.container.style.top="12mm";this.tabs.container.style.bottom="0mm";this.tabs.container.addEventListener(netgis.Events.TABS_CHANGE,this.onTabsChange.bind(this));this.tabs.attachTo(this.modal.content)};
netgis.Import.prototype.initSections=function(a){this.sections={};var b=0;if(a["import"]&&!0===a["import"].geoportal_tab){this.sections.geoportal=this.tabs.getContentSection(b);b+=1;this.sections.geoportal.classList.add("netgis-geoportal");this.geoportalSearch=new netgis.Search("Thema, Schlagwort...");this.geoportalSearch.autocomplete=a["import"].geoportal_search_dynamic;this.geoportalSearch.container.addEventListener(netgis.Events.SEARCH_CHANGE,this.onGeoportalSearchChange.bind(this));this.geoportalSearch.container.addEventListener(netgis.Events.SEARCH_CLEAR,
this.onGeoportalSearchClear.bind(this));this.geoportalSearch.attachTo(this.sections.geoportal);var c=document.createElement("span");c.innerHTML="Suche im Datenkatalog:";this.geoportalSearch.label.insertBefore(c,this.geoportalSearch.label.firstChild);c=document.createElement("button");c.innerHTML="Suchen";c.className="netgis-color-a netgis-hover-c netgis-round netgis-shadow";c.setAttribute("type","button");c.addEventListener("click",this.onGeoportalSearchButtonClick.bind(this));this.geoportalSearch.label.appendChild(c);
this.geoportalLoader=document.createElement("div");this.geoportalLoader.className="netgis-loader netgis-text-a netgis-hide";this.geoportalLoader.innerHTML="<i class='fas fa-cog'></i>";this.sections.geoportal.appendChild(this.geoportalLoader);this.geoportalResults=new netgis.Tree;this.geoportalResults.container.addEventListener(netgis.Events.TREE_ITEM_CHANGE,this.onGeoportalTreeItemChange.bind(this));this.geoportalResults.attachTo(this.sections.geoportal);c=document.createElement("div");c.style.position=
"absolute";c.style.left="0mm";c.style.right="0mm";c.style.bottom="0mm";c.style.padding="8mm";c.style.paddingTop="0mm";this.sections.geoportal.appendChild(c);this.geoportalSubmit=this.addButton(c,"<i class='netgis-icon fas fa-check'></i><span>Hinzuf\u00fcgen<span class='netgis-count'></span></span>",this.onGeoportalSubmit.bind(this))}a["import"]&&!1!==a["import"].wms_tab&&(this.sections.wms=this.tabs.getContentSection(b),b+=1,c=document.createElement("div"),c.className="netgis-search",this.sections.wms.appendChild(c),
this.addInputText(c,"WMS-URL:",this.config["import"].wms_options).classList.add("netgis-round","netgis-shadow"),this.addButton(this.sections.wms,"<i class='netgis-icon fas fa-cloud-download-alt'></i><span>Dienst laden</span>",this.onWMSLoadClick.bind(this)),c=document.createElement("input"),c.setAttribute("type","hidden"),this.sections.wms.appendChild(c),this.addInputText(this.sections.wms,"Bezeichnung:"),this.addInputSelect(this.sections.wms,"Ebene:"),this.addInputSelect(this.sections.wms,"Format:"),
this.addButton(this.sections.wms,"<i class='netgis-icon fas fa-check'></i><span>Hinzuf\u00fcgen</span>",this.onWMSAcceptClick.bind(this)),this.showDetailsWMS(!1));a["import"]&&!1!==a["import"].wfs_tab&&(this.sections.wfs=this.tabs.getContentSection(b),b+=1,c=document.createElement("div"),c.className="netgis-search",this.sections.wfs.appendChild(c),this.addInputText(c,"WFS-URL:",this.config["import"].wfs_options).classList.add("netgis-round","netgis-shadow"),this.addButton(this.sections.wfs,"<i class='netgis-icon fas fa-cloud-download-alt'></i><span>Dienst laden</span>",
this.onWFSLoadClick.bind(this)),this.addInputText(this.sections.wfs,"Bezeichnung:"),this.addInputSelect(this.sections.wfs,"Ebene:"),this.addInputSelect(this.sections.wfs,"Format:"),this.addButton(this.sections.wfs,"<i class='netgis-icon fas fa-check'></i><span>Hinzuf\u00fcgen</span>",this.onWFSAcceptClick.bind(this)),this.showDetailsWFS(!1));a["import"]&&!1!==a["import"].geojson_tab&&(this.sections.geojson=this.tabs.getContentSection(b),b+=1,this.addInputFile(this.sections.geojson,"GeoJSON-Datei:",
".geojson,.json"),this.addText(this.sections.geojson,"<h3>Unterst\u00fctzte Koordinatensysteme:</h3><ul><li>Web Mercator (EPSG:3857)</li><li>WGS84 / Lon-Lat (EPSG:4326)</li><li>ETRS89 / UTM Zone 32N (EPSG:25832)</li></ul>"),this.addButton(this.sections.geojson,"<i class='netgis-icon fas fa-check'></i><span>Datei laden</span>",this.onGeoJSONAcceptClick.bind(this)));a["import"]&&!1!==a["import"].gml_tab&&(this.sections.gml=this.tabs.getContentSection(b),b+=1,this.addInputFile(this.sections.gml,"GML-Datei:",
".gml,.xml"),this.addText(this.sections.gml,"<h3>Unterst\u00fctzte Koordinatensysteme:</h3><ul><li>Web Mercator (EPSG:3857)</li><li>WGS84 / Lon-Lat (EPSG:4326)</li><li>ETRS89 / UTM Zone 32N (EPSG:25832)</li></ul>"),this.addButton(this.sections.gml,"<i class='netgis-icon fas fa-check'></i><span>Datei laden</span>",this.onGMLAcceptClick.bind(this)));a["import"]&&!1!==a["import"].geopackage_tab&&(this.sections.geopackage=this.tabs.getContentSection(b),b+=1,this.addInputFile(this.sections.geopackage,
"GeoPackage-Datei:",".gpkg"),this.addText(this.sections.geopackage,"<h3>Unterst\u00fctzte Koordinatensysteme:</h3><ul><li>Web Mercator (EPSG:3857)</li><li>WGS84 / Lon-Lat (EPSG:4326)</li><li>ETRS89 / UTM Zone 32N (EPSG:25832)</li></ul>"),this.addButton(this.sections.geopackage,"<i class='netgis-icon fas fa-check'></i><span>Datei laden</span>",this.onGeoPackageAcceptClick.bind(this)));a["import"]&&!1!==a["import"].spatialite_tab&&(this.sections.spatialite=this.tabs.getContentSection(b),b+=1,this.addInputFile(this.sections.spatialite,
"Spatialite-Datei:",".sqlite"),this.addText(this.sections.spatialite,"<h3>Unterst\u00fctzte Koordinatensysteme:</h3><ul><li>Web Mercator (EPSG:3857)</li><li>WGS84 / Lon-Lat (EPSG:4326)</li><li>ETRS89 / UTM Zone 32N (EPSG:25832)</li></ul>"),this.addButton(this.sections.spatialite,"<i class='netgis-icon fas fa-check'></i><span>Datei laden</span>",this.onSpatialiteAcceptClick.bind(this)));a["import"]&&!1!==a["import"].shapefile_tab&&(this.sections.shapefile=this.tabs.getContentSection(b),this.addInputFile(this.sections.shapefile,
...
netgis.Import.prototype.onPreviewTreeItemChange=function(a){a=a.detail;var b=this.previewMap.getLayers().getArray()[1].getSource().getFeatureById(a.id);a.checked?b.setStyle(null):b.setStyle(new ol.style.Style({}))};
...
h=l.getElementsByClassName("netgis-count")[0];h.innerHTML=Number.parseInt(h.innerText)+g}else{var l=e.title+" (<span class='netgis-count'>"+g+"</span>)";k=this.geoportalResults.addFolder(null,d,l,!1,!1,!1,!1,this.config["import"].clip_titles);k.setAttribute("title",e["abstract"]);c[h]=k}for(g=0;g<f.length;g++)this.geoportalResults.addCheckbox(k,g,f[g].title,!1,!1,null,this.config["import"].clip_titles);e.children=f;this.geoportalData.push(e)}this.geoportalLoader.classList.add("netgis-hide")}};
netgis.Import.prototype.updateGeoportalResults=function(a,b){this.geoportalData={data:a,folders:{}};a=a.wms.srv;if(b){b={};for(var c=0;c<a.length;c++){var d=a[c],e=d.title;d.wmsRootLayerId&&(e=d.wmsRootLayerId);if(b[e]){var f=b[e];f.getElementsByTagName("summary")}else f=this.geoportalResults.addFolder(null,e,d.title,!1,!1,!1,!1,this.config["import"].clip_titles),f.setAttribute("title",d["abstract"]),f.setAttribute("data-url",d.wmsGetCapabilitiesUrl),f.setAttribute("data-title",d.title),f.setAttribute("data-root-id",
d.wmsRootLayerId),f.getElementsByTagName("details")[0].addEventListener("toggle",this.onGeoportalFolderToggle.bind(this)),f.getElementsByTagName("input")[0].setAttribute("disabled","disabled"),b[e]=f}this.geoportalData.folders=b}this.geoportalResults.container.scrollTop=0;this.geoportalLoader.classList.add("netgis-hide")};
netgis.Import.prototype.onGeoportalFolderToggle=function(a){a=a.currentTarget;var b=a.parentNode,c=a.getElementsByTagName("netgis-item");!a.open||0<c||(a=b.getAttribute("data-url"),netgis.util.request(a,function(a){this.onGeoportalFolderResponse(b,a,!1)}.bind(this)),b.getElementsByTagName("ul")[0].innerHTML="",0===b.getElementsByClassName("netgis-loader").length&&this.geoportalResults.addButton(b,0,"<span class='netgis-loader netgis-color-e netgis-text-a'><i class='fas fa-spinner'></i></span>",null))};
netgis.Import.prototype.onGeoportalFolderResponse=function(a,b,c,d){a.getElementsByTagName("ul")[0].innerHTML="";a.getElementsByTagName("input")[0].removeAttribute("disabled");b=netgis.WMS.parseCapabilities(b);var e=!0;this.config["import"]&&!1===this.config["import"].geoportal_order_reverse&&(e=!1);this.createGeoportalLayers(a,b,b.layers,!0,e,c,d);this.config["import"]&&!0===this.config["import"].geoportal_simplify_folders&&this.simplifyGeoportalFolder(a);c=!1;this.config["import"]&&!0===this.config["import"].geoportal_order_by_meta&&
(c=!0);if(c){c=[];b=this.geoportalData.data.wms.srv;for(d=0;d<b.length;d++)if(c.push(b[d].title),e=b[d].layer)for(var f=0;f<e.length;f++){c.push(e[f].title);var g=e[f].layer;if(g)for(var h=0;h<g.length;h++)c.push(g[h].title)}b=a.getElementsByTagName("li");for(d=0;d<b.length;d++)e=b[d],f=c.indexOf(e.innerText),e.setAttribute("data-order",f);this.geoportalResults.reorderByAttribute("data-order",!1,!0,a.getElementsByTagName("ul")[0])}};
...
netgis.Import.prototype.createGeoportalLayers=function(a,b,c,d,e,f,g){g||(g=this.geoportalResults);var h=a.getAttribute("data-id"),k=b.requests.map.url,l=b.requests.info.url,n=null;-1<b.requests.map.format.indexOf("image/jpeg")&&(n="image/jpeg");-1<b.requests.map.format.indexOf("image/png")&&(n="image/png");var m=null;-1<b.requests.info.format.indexOf("text/plain")&&(m="text/plain");-1<b.requests.info.format.indexOf("text/html")&&(m="text/html");for(var q=0;q<c.length;q++){var p=c[q],t=h+"_"+p.name;
p.id=t;if(0===p.children.length){var r=null;!0===f&&(r={id:t,folder:h,title:p.title,active:!0,query:!0,type:netgis.LayerTypes.WMS,url:k,name:p.name,order:11E3+q,transparency:0},this.config.layers.push(r),r=client.modules.layertree.createDefaultDetails(r,!0,!0,!0));r=g.addCheckbox(a,t,p.title,!1,e,r,this.config["import"].clip_titles);r.setAttribute("title",p.abstract);r=r.getElementsByTagName("input")[0];r.setAttribute("data-map-url",k);r.setAttribute("data-info-url",l);r.setAttribute("data-map-format",
n);r.setAttribute("data-info-format",m);r.setAttribute("data-name",p.name);r.setAttribute("data-title",p.title);r.setAttribute("data-queryable",p.queryable);!0===f&&g.setItemChecked(t,!0,!1)}else{var u=r=!1;!0===f&&(u=r=!0);t=g.addFolder(a,t,p.title,e,!1,r,u,this.config["import"].clip_titles);t.setAttribute("title",p.abstract);t.setAttribute("data-title",p.title);d&&this.createGeoportalLayers(t,b,p.children,!0,e,f,g)}}};
netgis.Import.prototype.getGeoportalLayerMetadata=function(a,b){if(!a)return null;b||(b=this.geoportalData.data.wms.srv);for(var c=0;c<b.length;c++){var d=b[c],e=d.id;e=Number.parseInt(e);if(e===a)return d;if(d.layer)for(d=d.layer,e=0;e<d.length;e++){var f=d[e],g=f.id;g=Number.parseInt(g);if(g===a)return f;if(f.layer)for(f=f.layer,g=0;g<f.length;g++){var h=f[g],k=h.id;k=Number.parseInt(k);if(k===a)return h}}}return null};netgis.Import.prototype.onGeoportalSearchButtonClick=function(a){this.geoportalSearch.onInputTimeout()};
...
netgis.Import.prototype.onGeoportalSubmitDynamic=function(a){var b=0,c=!0;this.config["import"]&&!1===this.config["import"].geoportal_import_hierarchy&&(c=!1);var d=this.geoportalResults.container.getElementsByTagName("li");for(a=0;a<d.length;a++){var e=d[a],f=e.getElementsByTagName("input")[0];if(f.checked){b+=1;var g=null,h=e.parentNode;h.classList.contains("netgis-tree")||(h=e.parentNode,g="geoportal_"+h.parentNode.parentNode.getAttribute("data-id"));if(e.classList.contains("netgis-folder"))f=
e.getAttribute("data-id"),f="geoportal_"+f,h=e.getAttribute("data-title"),e=e.getElementsByTagName("details")[0].hasAttribute("open"),g={folder:{parent:c?g:null,id:f,title:h,open:e}},netgis.util.invoke(this.sections.geoportal,netgis.Events.IMPORT_GEOPORTAL_SUBMIT,g);else if(e.classList.contains("netgis-item")){e=f.getAttribute("data-id");e="geoportal_"+e;h=f.getAttribute("data-title");var k=f.getAttribute("data-map-url");f=f.getAttribute("data-name");g={layer:{folder:g,id:e,url:k,name:f,title:h,order:11E3-
a}};netgis.util.invoke(this.sections.geoportal,netgis.Events.IMPORT_GEOPORTAL_SUBMIT,g)}}}if(0<b){this.modal.hide();b=this.geoportalResults.container.getElementsByTagName("input");for(a=0;a<b.length;a++)b[a].checked=!1;this.geoportalResults.updateFolderChecks();this.onGeoportalTreeItemChange()}};
netgis.Import.prototype.onGeoportalSubmitDynamic_01=function(a){var b=this.geoportalResults.container.getElementsByClassName("netgis-item"),c=!1;this.config["import"]&&!0===this.config["import"].geoportal_import_hierarchy&&(c=!0);var d=0;for(a=0;a<b.length;a++){var e=b[a],f=e.getElementsByTagName("input")[0];if(f.checked){d+=1;e=e.parentNode.parentNode.parentNode;var g=f.getAttribute("data-id"),h=e.getAttribute("data-id");g="geoportal_"+g;h="geoportal_"+h;var k=e.getAttribute("data-title"),l=f.getAttribute("data-title"),
n=f.getAttribute("data-map-url");f=f.getAttribute("data-name");f={folder:{id:h,title:k},layer:{id:g,url:n,name:f,title:l}};if(c)for(f.folders=[],e=e.parentNode,e=e.parentNode,e=e.parentNode;e.classList.contains("netgis-folder");)f.folders.push({el:e,id:"geoportal_"+e.getAttribute("data-id"),title:e.getAttribute("data-title")}),e=e.parentNode,e=e.parentNode,e=e.parentNode;netgis.util.invoke(this.sections.geoportal,netgis.Events.IMPORT_GEOPORTAL_SUBMIT,f)}}if(0<d){this.modal.hide();b=this.geoportalResults.container.getElementsByTagName("input");
for(a=0;a<b.length;a++)b[a].checked=!1;this.geoportalResults.updateFolderChecks();this.onGeoportalTreeItemChange()}};
...
netgis.Info.prototype.onSearchPlaceClear=function(a){this.popup.hide()};netgis=netgis||{};netgis.LayerID={EDITABLE:"editable-layer",NON_EDITABLE:"non-editable-layer"};netgis=netgis||{};netgis.LayerTree=function(a){this.config=a;this.importFolder=null;this.initElements(a);this.initFolders();this.initConfig(a,!1,!0)};netgis.LayerTree.Config={open:!1,title:"Layers",clip_titles:!1,draggable:!1,buttons:[]};netgis.LayerTree.Folders=[];
netgis.LayerTree.prototype.initElements=function(a){a=a.layertree;this.panel=new netgis.Panel("Layers");this.panel.container.style.minWidth="82mm";this.tree=new netgis.Tree(a.draggable);this.tree.attachTo(this.panel.content);this.tree.container.addEventListener(netgis.Events.TREE_ITEM_CHANGE,this.onTreeItemChange.bind(this));this.tree.container.addEventListener(netgis.Events.TREE_ITEM_SLIDER_CHANGE,this.onTreeItemSliderChange.bind(this));this.tree.container.addEventListener(netgis.Events.TREE_ITEM_ORDER_CHANGE,
this.onTreeItemOrderChange.bind(this));this.tree.container.addEventListener(netgis.Events.TREE_ITEM_REMOVE,this.onTreeItemRemove.bind(this));!0===a.draggable&&(this.panel.content.addEventListener("dragover",this.onDragOver.bind(this)),this.panel.content.addEventListener("drop",this.onDragDrop.bind(this)))};
netgis.LayerTree.prototype.initFolders=function(){this.editFolder=this.tree.addFolder(null,"edit-folder","Zeichnung",!0,!0,!1,!1,this.config.layertree.clip_titles);this.tree.addCheckbox(this.editFolder,netgis.LayerID.EDITABLE,"Editierbar");this.tree.setItemChecked(netgis.LayerID.EDITABLE,!0);this.tree.addCheckbox(this.editFolder,netgis.LayerID.NON_EDITABLE,"Nicht-Editierbar");this.tree.setItemChecked(netgis.LayerID.NON_EDITABLE,!0);this.editFolder.classList.add("netgis-hide")};
netgis.LayerTree.prototype.initConfig=function(a,b,c){var d=this.config.layertree;d&&d.title&&this.panel.setTitle(d.title);var e=a.folders,f={};if(e){for(var g=0;g<e.length;g++){var h=e[g],k=this.tree.addFolder(null,h.id,h.title,b,!1,h.draggable,h.removable,d?d.clip_titles:!1);f[h.id]=k;!0===h.open&&this.tree.setFolderOpen(h.id,!0);h.data&&this.tree.setItemData(k,h.data)}for(g=0;g<e.length;g++)h=e[g],k=h.id,h=h.parent,-1===h&&(h=null),""===h&&(h=null),h&&this.tree.setFolderParent(f[k],f[h])}if(a=
a.layers)for(g=0;g<a.length;g++){b=a[g];h=f[b.folder]?f[b.folder]:null;k=b.id?b.id:g.toString();var l=!1;if(h)for(var n=0;n<e.length;n++){var m=e[n];m.id===b.folder&&(l=m.radio)}n=b.title;var q='<i class="fas fa-mouse-pointer" title="Ebene ist abfragbar"></i>';m=!1;d&&d.query_icon&&(q=d.query_icon);(!0===b.query||b.query_url&&""!==b.query_url)&&q&&""!==q&&(m=!0);q=b.removable;k=!0===l?this.tree.addRadioButton(h,k,n,b.active,this.createDefaultDetails(b,!0,q,m),d?d.clip_titles:!1):this.tree.addCheckbox(h,
k,n,b.active,!1,this.createDefaultDetails(b,!0,q,m),d?d.clip_titles:!1);k.addEventListener("contextmenu",this.onTreeItemMenu.bind(this));b.data&&this.tree.setItemData(k,b.data);!0===b.hidden&&k.classList.add("netgis-hide")}this.tree.updateFolderChecks();if(!0===c){if(d&&d.buttons)for(c=d.buttons,g=0;g<c.length;g++)e=c[g],this.tree.addButton(null,e.id,e.title,this.onTreeButtonClick.bind(this));d&&!0===d.open&&this.panel.show()}};
...
netgis.LayerTree.prototype.createDefaultDetails=function(a,b,c,d){var e=[];e.push({title:"<i class='netgis-icon fas fa-mouse-pointer'></i> Abfragbar",type:"checkbox",val:!0===d,locked:!0});!0===b&&e.push({title:"<i class='netgis-icon fas fa-eye-slash'></i> Transparenz",type:"slider",val:a.transparency?Math.round(100*a.transparency):0});!0===c&&e.push({title:"<i class='netgis-icon fas fa-times'></i> Entfernen",type:"button",callback:this.onTreeItemDeleteClick.bind(this)});return e};
netgis.LayerTree.prototype.onTreeItemChange=function(a){var b=a.detail;netgis.util.invoke(a.target,netgis.Events.MAP_LAYER_TOGGLE,{id:b.id,on:b.checked})};netgis.LayerTree.prototype.onClientContextResponse=function(a){this.initConfig(a.detail.context.config,!0,!1)};netgis.LayerTree.prototype.onLayerTreeToggle=function(a){this.panel.toggle()};netgis.LayerTree.prototype.onTreeButtonClick=function(a){a=a.currentTarget;var b=a.getAttribute("data-id");netgis.Client.handleCommand(a,b)};
netgis.LayerTree.prototype.onMapLayerCreate=function(a){this.addLayerItem(a.detail,null)};netgis.LayerTree.prototype.onMapLayerToggle=function(a){a=a.detail;this.tree.setItemChecked(a.id,a.on,!0);this.tree.updateFolderChecks()};netgis.LayerTree.prototype.onImportLayerAccept=function(a){a=a.detail;!0!==a.editable&&(this.importFolder||(this.importFolder=this.tree.addFolder(null,"_import","Import",!0,!1,!0,this.config.layertree.clip_titles)),this.addLayerItem(a,this.importFolder),this.tree.updateFolderChecks())};
netgis.LayerTree.prototype.addLayerItem=function(a,b){var c=a.title,d='<i class="fas fa-mouse-pointer" title="Ebene ist abfragbar"></i>',e=!1;this.config.layertree&&this.config.layertree.query_icon&&(d=this.config.layertree.query_icon);(!0===a.query||a.query_url&&""!==a.query_url)&&d&&""!==d&&(e=!0);a=this.tree.addCheckbox(b,a.id,c,!0===a.active,!0,this.createDefaultDetails(a,!0,!0,e),this.config.layertree.clip_titles);a.addEventListener("contextmenu",this.onTreeItemMenu.bind(this));return a};
netgis.LayerTree.prototype.onImportGeoportalSubmit=function(a){a=a.detail;if(a.folder){var b=a.folder.id,c=this.tree.getFolder(b);if(!c){var d=a.folder.parent?!1:!0;this.tree.addFolder(this.tree.getFolder(a.folder.parent),b,a.folder.title,d,!1,!0,!0,this.config.layertree.clip_titles);a.folder.open&&this.tree.setFolderOpen(b,!0)}}if(a.layer){var e=a.layer.id;b=a.layer.folder;var f={id:e,folder:b,title:a.layer.title,active:!0,query:!0,type:netgis.LayerTypes.WMS,url:a.layer.url,name:a.layer.name,order:a.layer.order,
transparency:0};this.config.layers.push(f);c=this.tree.getFolder(b);d=a.layer.folder?!1:!0;this.tree.addCheckbox(c,e,a.layer.title,!1,d,this.createDefaultDetails(f,!0,!0,!0),this.config.layertree.clip_titles);this.tree.setItemChecked(e,!0,!1)}};
netgis.LayerTree.prototype.onImportGeoportalSubmit_01=function(a){a=a.detail;var b=a.folder.id,c=this.tree.getFolder(b);if(!c)if(a.folders){c=a.folders;for(var d=null,e=c.length-1;0<=e;e--){var f=c[e],g=this.tree.getFolder(f.id);d=g?g:this.tree.addFolder(d,f.id,f.title,!0,!1,!0,!0,this.config.layertree.clip_titles)}c=this.tree.addFolder(d,b,a.folder.title,!0,!1,!0,!0,this.config.layertree.clip_titles)}else c=this.tree.addFolder(null,b,a.folder.title,!0,!1,!0,!0,this.config.layertree.clip_titles);
d=a.layer.id;b={id:d,folder:b,title:a.layer.title,active:!0,query:!0,type:netgis.LayerTypes.WMS,url:a.layer.url,name:a.layer.name,order:1E4,transparency:0};this.config.layers.push(b);this.tree.addCheckbox(c,d,a.layer.title,!1,!1,this.createDefaultDetails(b,!0,!0,!0),this.config.layertree.clip_titles);this.tree.setItemChecked(d,!0,!1)};netgis.LayerTree.prototype.onTreeItemMenu=function(a){a.preventDefault();return!1};
netgis.LayerTree.prototype.onContextMenuSliderChange=function(a){var b=a.detail;a=.01*b.val;var c=null;0===b.id.indexOf("layer_trans_")&&(c=b.id.split("layer_trans_")[1]);b=this.config.layers;for(var d=0;d<b.length;d++){var e=b[d];if(e.id===c){e.transparency=a;break}}netgis.util.invoke(this.tree.container,netgis.Events.MAP_LAYER_TRANSPARENCY,{id:c,transparency:a})};
...
netgis.Legend.prototype.show=function(){this.panel.show()};netgis.Legend.prototype.hide=function(){this.panel.hide()};
netgis.Legend.prototype.addSection=function(a,b,c,d){var e=document.createElement("details");e.setAttribute("data-id",a);d&&e.setAttribute("open","open");a=document.createElement("summary");a.className="netgis-button netgis-noselect netgis-clip-text netgis-color-d netgis-hover-text-a netgis-hover-d";a.innerHTML=b;e.appendChild(a);b=document.createElement("div");b.className="netgis-border-d";b.innerHTML=c;e.appendChild(b);this.panel.content.appendChild(e)};
...
this.onCutFeaturesDrawEnd.bind(this))}};netgis.Map.prototype.initConfig=function(a){var b=a.map;if(b){var c=b.bbox;if(c){for(var d=!0,e=0;e<c.length;e++)Number.isNaN(c[e])&&(d=!1);d&&this.zoomBBox(a.map.bbox)}!b.zoom||b.extent||b.scale||this.view.setZoom(a.map.zoom);b.max_view_history&&(this.viewHistoryMax=b.max_view_history)}if(a=a.layers)for(e=a.length-1;0<=e;e--)b=a[e],!0===b.active&&this.addLayer(b.id,b)};
...
this.onMapZoom.bind(this));a.addEventListener(netgis.Events.MAP_ZOOM_HOME,this.onMapZoomHome.bind(this));a.addEventListener(netgis.Events.MAP_ZOOM_LONLAT,this.onMapZoomLonLat.bind(this));a.addEventListener(netgis.Events.MAP_ZOOM_SCALE,this.onMapZoomScale.bind(this));a.addEventListener(netgis.Events.MAP_ZOOM_LAYER,this.onMapZoomLayer.bind(this));a.addEventListener(netgis.Events.MAP_ZOOM_LEVEL,this.onMapZoomLevel.bind(this));a.addEventListener(netgis.Events.MAP_ZOOM_BBOX,this.onMapZoomBBox.bind(this));
a.addEventListener(netgis.Events.MAP_LAYER_CREATE,this.onMapLayerCreate.bind(this));a.addEventListener(netgis.Events.MAP_LAYER_TOGGLE,this.onMapLayerToggle.bind(this));a.addEventListener(netgis.Events.MAP_LAYER_TRANSPARENCY,this.onMapLayerTransparency.bind(this));a.addEventListener(netgis.Events.MAP_LAYER_ORDER,this.onMapLayerOrder.bind(this));a.addEventListener(netgis.Events.MAP_LAYER_DELETE,this.onMapLayerDelete.bind(this));a.addEventListener(netgis.Events.MAP_SNAP_TOGGLE,this.onMapSnapToggle.bind(this));
a.addEventListener(netgis.Events.MAP_VIEW_PREV,this.onMapViewPrev.bind(this));a.addEventListener(netgis.Events.MAP_VIEW_NEXT,this.onMapViewNext.bind(this));a.addEventListener(netgis.Events.GEOLOCATION_TOGGLE_ACTIVE,this.onGeolocToggleActive.bind(this));a.addEventListener(netgis.Events.GEOLOCATION_CHANGE,this.onGeolocChange.bind(this));a.addEventListener(netgis.Events.MEASURE_CLEAR,this.onMeasureClear.bind(this));a.addEventListener(netgis.Events.SELECT_MULTI_TOGGLE,this.onSelectMultiToggle.bind(this));
a.addEventListener(netgis.Events.DRAW_BUFFER_TOGGLE,this.onDrawBufferToggle.bind(this));a.addEventListener(netgis.Events.DRAW_BUFFER_CHANGE,this.onDrawBufferChange.bind(this));a.addEventListener(netgis.Events.BUFFER_CHANGE,this.onBufferChange.bind(this));a.addEventListener(netgis.Events.BUFFER_ACCEPT,this.onBufferAccept.bind(this));a.addEventListener(netgis.Events.IMPORT_LAYER_ACCEPT,this.onImportLayerAccept.bind(this));a.addEventListener(netgis.Events.IMPORT_LAYER_PREVIEW,this.onImportLayerPreview.bind(this));
a.addEventListener(netgis.Events.IMPORT_GEOPORTAL_SUBMIT,this.onImportGeoportalSubmit.bind(this));a.addEventListener(netgis.Events.MAP_COPY_FEATURE_TO_EDIT,this.onCopyFeatureToEdit.bind(this));a.addEventListener(netgis.Events.SEARCHPLACE_SELECT,this.onSearchPlaceSelect.bind(this));a.addEventListener(netgis.Events.SEARCHPLACE_CLEAR,this.onSearchPlaceClear.bind(this));a.addEventListener(netgis.Events.SEARCHPARCEL_ITEM_ENTER,this.onSearchParcelItemEnter.bind(this));a.addEventListener(netgis.Events.SEARCHPARCEL_ITEM_LEAVE,
this.onSearchParcelItemLeave.bind(this));a.addEventListener(netgis.Events.SEARCHPARCEL_ITEM_CLICK,this.onSearchParcelItemClick.bind(this));a.addEventListener(netgis.Events.SEARCHPARCEL_ITEM_IMPORT,this.onSearchParcelItemImport.bind(this));a.addEventListener(netgis.Events.EXPORT_BEGIN,this.onExportBegin.bind(this));a.addEventListener(netgis.Events.TIMESLIDER_SHOW,this.onTimeSliderShow.bind(this));a.addEventListener(netgis.Events.TIMESLIDER_HIDE,this.onTimeSliderHide.bind(this));a.addEventListener(netgis.Events.TIMESLIDER_SELECT,
this.onTimeSliderSelect.bind(this))};
netgis.Map.prototype.setMode=function(a){switch(this.mode){case netgis.Modes.VIEW:this.container.classList.remove("netgis-clickable");break;case netgis.Modes.MODIFY_FEATURES:this.editLayer.setStyle(this.styleEdit.bind(this));break;case netgis.Modes.DRAW_POINTS:case netgis.Modes.DRAW_LINES:this.previewLayer.getSource().clear();this.container.classList.remove("netgis-not-allowed");this.container.removeAttribute("title");break;case netgis.Modes.DRAW_POLYGONS:this.container.classList.remove("netgis-not-allowed");this.container.removeAttribute("title");
break;case netgis.Modes.BUFFER_FEATURES:this.clearSketchFeatures();break;case netgis.Modes.BUFFER_FEATURES_EDIT:this.clearSketchFeatures();this.selectedFeatures=[];this.redrawVectorLayers();break;case netgis.Modes.BUFFER_FEATURES_DYNAMIC:this.clearSketchFeatures();this.selectedFeatures=[];this.redrawVectorLayers();break;case netgis.Modes.CUT_FEATURES:a!==netgis.Modes.CUT_FEATURES_DRAW&&(this.selectedFeatures=[],this.redrawVectorLayers());break;case netgis.Modes.CUT_FEATURES_DRAW:this.selectedFeatures=
...
30,140,30);q.fillStyle="#000";q.font="4mm sans-serif";q.fillText(netgis.util.getTimeStamp(),10,m.height-10);var p=document.createElement("a");switch(a){case "pdf":e=e?e:0;var t=297-e-e,r=210-e-e,u=m.width/m.height;if(!d){var w=t;t=r;r=w}if(m.height>m.width){var v=r;w=v*u;w>t&&(w=t,v=w/u)}else w=t,v=w/u,v>r&&(v=r,w=v*u);u=new jsPDF(d?"l":"p");var x=e;x+=(t-w)/2;t=e;t+=(r-v)/2;u.addImage(m.toDataURL("image/png,1.0",1),"PNG",x,t,w,v);u.setFillColor(255,255,255);u.rect(x,t+v-11,80,11,"F");u.setFontSize(8);
u.text("Datum: "+netgis.util.getTimeStamp(),x+2,t+v-2-4);u.text("Quelle: "+window.location.href,x+2,t+v-2);m=u.output("bloburl",{filename:k.default_filename+".pdf"});window.open(m,"_blank");break;case "jpeg":window.navigator.msSaveBlob?window.navigator.msSaveBlob(m.msToBlob(),k.default_filename+".jpg"):(p.setAttribute("download",k.default_filename+".jpg"),p.setAttribute("href",m.toDataURL("image/jpeg",1)),p.click());break;case "png":window.navigator.msSaveBlob?window.navigator.msSaveBlob(m.msToBlob(),
k.default_filename+".png"):(p.setAttribute("download",k.default_filename+".png"),p.setAttribute("href",m.toDataURL("image/png",1)),p.click());break;case "gif":p.setAttribute("download",k.default_filename+".gif"),r=new GIF({workerScript:k.gif_worker,quality:1}),r.addFrame(m),r.on("finished",function(a){p.setAttribute("href",window.URL.createObjectURL(a));p.click()}),r.render()}h.setTarget(g);g.removeChild(n);netgis.util.invoke(f.container,netgis.Events.EXPORT_END,null)});h.renderSync()};l.src=k.logo};
...
netgis.Map.prototype.onMapZoomLayer=function(a){a=a.detail;var b=this.layers[a.id];b?this.view.fit(b.getSource().getExtent(),{duration:600}):console.warning("trying to zoom non existing layer",a.id)};netgis.Map.prototype.onMapZoomLevel=function(a){this.view.setZoom(a.detail.z)};netgis.Map.prototype.onMapZoomBBox=function(a){a=a.detail;this.zoomExtentLonLat(a.minlon,a.minlat,a.maxlon,a.maxlat)};netgis.Map.prototype.onMapViewPrev=function(a){this.gotoViewHistory(this.viewIndex-1)};
netgis.Map.prototype.onMapViewNext=function(a){this.gotoViewHistory(this.viewIndex+1)};
...
netgis.Map.prototype.onGeolocChange=function(a){a=a.detail;this.geolocLayer.getSource().getFeatures()[0].getGeometry().setCoordinates(ol.proj.fromLonLat([a.lon,a.lat],this.view.getProjection()));!0===a.center&&this.zoomLonLat(a.lon,a.lat,a.zoom?a.zoom:this.view.getZoom())};netgis.Map.prototype.onMeasureLineBegin=function(a){this.measureLayer.getSource().clear()};netgis.Map.prototype.onMeasureAreaBegin=function(a){this.measureLayer.getSource().clear()};netgis.Map.prototype.onMeasureClear=function(a){this.measureLayer.getSource().clear()};
...
netgis.Tree.prototype.addFolder=function(a,b,c,d,e,f,g,h){var k=document.createElement("li");k.className="netgis-folder";k.setAttribute("data-id",b);k.setAttribute("data-removable",g?!0:!1);b=document.createElement("details");k.appendChild(b);var l=document.createElement("summary");l.className="netgis-button netgis-noselect netgis-color-e netgis-hover-d";!0===h&&(l.className+=" netgis-clip-text");l.innerHTML="<i class='netgis-icon netgis-hide-open fas fa-folder'></i><i class='netgis-icon netgis-show-open fas fa-folder-open'></i><span>"+
c+"</span>";b.appendChild(l);!0===this.draggable&&(netgis.util.isDefined(f)&&!0!==f||this.setItemDraggable(l));!0===g&&(c=document.createElement("button"),c.className="netgis-closer netgis-clickable netgis-color-d netgis-hover-d",c.innerHTML="<i class='fas fa-times'></i>",c.addEventListener("click",this.onFolderDeleteClick.bind(this)),l.appendChild(c));c=document.createElement("label");l.appendChild(c);l=document.createElement("input");l.setAttribute("type","checkbox");l.onchange=this.onFolderChange.bind(this);
c.appendChild(l);!0===e&&k.classList.add("netgis-nocheck");e=document.createElement("ul");b.appendChild(e);a=a?a.getElementsByTagName("ul")[0]:this.container;d?a.insertBefore(k,a.firstChild):a.appendChild(k);return k};
netgis.Tree.prototype.addCheckbox=function(a,b,c,d,e,f,g){var h=document.createElement("li");h.className="netgis-item";!0===this.draggable&&this.setItemDraggable(h);var k=document.createElement("label");k.className="netgis-button netgis-noselect netgis-color-e netgis-hover-d";!0===g&&(k.className+=" netgis-clip-text");k.innerHTML="<span>"+c+"</span>";h.appendChild(k);c=document.createElement("span");c.className="netgis-wrapper";k.insertBefore(c,k.firstChild);k=document.createElement("input");k.setAttribute("type",
"checkbox");k.setAttribute("data-id",b);d&&(k.checked=d);k.onchange=this.onItemChange.bind(this);c.appendChild(k);f&&this.addItemDetails(h,b,f);a=a?a.getElementsByTagName("ul")[0]:this.container;e?a.insertBefore(h,a.firstChild):a.appendChild(h);return h};
netgis.Tree.prototype.addRadioButton=function(a,b,c,d,e,f){var g=document.createElement("li");g.className="netgis-item";var h=document.createElement("label");h.className="netgis-button netgis-noselect netgis-color-e netgis-hover-d";!0===f&&(h.className+=" netgis-clip-text");h.innerHTML="<span>"+c+"</span>";g.appendChild(h);c=document.createElement("span");c.className="netgis-wrapper";h.insertBefore(c,h.firstChild);h=a?"radio-"+a.getAttribute("data-id"):"radio-noname";f=document.createElement("input");
f.setAttribute("type","radio");f.setAttribute("name",h);f.setAttribute("value","radio-"+b);f.setAttribute("data-id",b);d&&(f.checked=d);f.onchange=this.onItemChange.bind(this);c.appendChild(f);e&&this.addItemDetails(g,b,e);a?a.getElementsByTagName("ul")[0].appendChild(g):this.container.appendChild(g);return g};
...
"button");k.addEventListener("click",g.callback);k.className="netgis-button netgis-color-e netgis-hover-d";k.innerHTML=g.title;h.appendChild(k);break;case "checkbox":k=document.createElement("span");k.className="netgis-clip-text";k.innerHTML=g.title;h.appendChild(k);k=document.createElement("span");h.appendChild(k);var l=document.createElement("input");l.setAttribute("type","checkbox");l.setAttribute("data-id",b);g.locked&&l.setAttribute("disabled","disabled");!0===g.val&&l.setAttribute("checked",
"checked");k.appendChild(l);break;case "slider":k=document.createElement("span"),k.className="netgis-clip-text",k.innerHTML=g.title,h.appendChild(k),k=document.createElement("span"),h.appendChild(k),l=document.createElement("input"),l.setAttribute("type","range"),l.setAttribute("min",0),l.setAttribute("max",100),l.setAttribute("step",1),l.setAttribute("value",g.val),l.setAttribute("data-id",b),l.addEventListener("change",this.onItemSliderChange.bind(this)),l.addEventListener("input",this.onItemSliderChange.bind(this)),
this.draggable&&(l.setAttribute("draggable","true"),l.addEventListener("dragstart",function(a){a.preventDefault();a.stopImmediatePropagation()})),k.appendChild(l)}e.appendChild(h)}a.appendChild(d)};
...
netgis.Tree.prototype.setItemData=function(a,b){for(var c in b)a.setAttribute("data-"+c,b[c])};
netgis.Tree.prototype.reorderByAttribute=function(a,b,c,d){d||(d=this.container);for(var e=d.children,f=[],g=0;g<e.length;g++){var h=e[g];if(h.hasAttribute(a)){var k=h.getAttribute(a);c&&(k=Number.parseInt(k));f.push({ref:h,val:k})}}f.sort(function(a,c){a=a.val;c=c.val;if(b){if(a<c)return 1;if(a>c)return-1}else{if(a<c)return-1;if(a>c)return 1}return 0});if(d===this.container)for(g=0;g<f.length-1;g++)e=f[g].ref,d.removeChild(e),d.insertBefore(e,f[g+1].ref);else for(g=0;g<f.length;g++)e=f[g].ref,d.removeChild(e),
d.appendChild(e);for(g=0;g<f.length;g++)e=f[g].ref,d=e.getElementsByTagName("ul"),0<d.length&&(d=d[0],this.reorderByAttribute(a,b,c,d))};netgis.Tree.prototype.getFolder=function(a){for(var b=this.container.getElementsByClassName("netgis-folder"),c=0;c<b.length;c++){var d=b[c];if(d.getAttribute("data-id")===a)return d}return null};netgis.Tree.prototype.getItem=function(a){for(var b=this.container.getElementsByTagName("input"),c=0;c<b.length;c++){var d=b[c];if(d.getAttribute("data-id")===a)return d}return null};
...
netgis.Tree.prototype.moveItemDown=function(a){var b=a.parentNode;b.removeChild(a);b.appendChild(a)};netgis.Tree.prototype.moveButtonsDown=function(){for(var a=this.container,b=a.getElementsByTagName("li"),c=[],d=0;d<b.length;d++){var e=b[d];e.classList.contains("netgis-folder")||e.classList.contains("netgis-item")||e.parentNode===a&&c.push(e)}for(d=0;d<c.length;d++)e=c[d],a.removeChild(e),a.appendChild(e)};
...
this.container.style.right="auto";this.container.style.bottom="auto"}};netgis.Window.prototype.onDocPointerUp=function(a){this.resizing=this.dragging=!1;this.container.classList.remove("netgis-dragging")};netgis.Window.prototype.onResizeObserve=function(a){this.dragging&&(this.dragging=!1,this.resizing=!0);a=this.container.getBoundingClientRect();netgis.util.invoke(this.container,netgis.Events.WINDOW_RESIZE,{x:a.x,y:a.y,w:a.width,h:a.height})};netgis=netgis||{};netgis.WMC=function(a){this.config=a};netgis.WMC.Config={url:"",layers_url:"",layers_removable:!1};netgis.WMC.prototype.requestContext=function(a,b){this.callback=b;netgis.util.request(a,this.onContextResponse.bind(this))};
netgis.WMC.prototype.onContextResponse=function(a){if(netgis.util.isJSON(a)){var b=JSON.parse(a);this.exportData=b;a=[];if(b=b.layerList)for(var c=0;c<b.length;c++)a.push(b[c].layerId);console.info("Layer IDs:",a);this.requestLayers(a)}else console.error("could not parse WMC response:",a),this.callback&&this.callback({config:null})};
netgis.WMC.prototype.requestLayers=function(a){var b=this.config.wmc;b?(b=b.layers_url,b=netgis.util.replace(b,"{ids}",a.join(",")),netgis.util.request(b,this.onLayersResponse.bind(this))):console.error("no config[ 'wmc' ] found, skipping WMC layer loading")};netgis.WMC.prototype.onLayersResponse=function(a){this.metaData=JSON.parse(a);console.info("WMC Export Data:",this.exportData);console.info("WMC Meta Data:",this.metaData);this.callback&&this.callback({config:this.toConfig()})};
netgis.WMC.prototype.toConfig=function(){var a=this.exportData.wmc,b=this.exportData.layerList,c=this.config&&this.config.wmc?this.config.wmc:null,d=c&&!0===c.layers_removable,e={},f=a.bbox;f=f.split(",");for(var g=0;g<f.length;g++)f[g]=Number.parseFloat(f[g]);e.map={projection:a.crs,bbox:f};e.attribution||(e.attribution={});e.attribution.prefix=e.attribution.prefix?a.title+", "+e.attribution.prefix:a.title;var h=e.folders=[];a=e.layers=[];for(g=b.length-1;0<=g;g--)if(f=b[g],null===f.layerParent){var k=
this.getLayerMetaData(f.layerId);if(k){var l={parent:null,id:f.layerId,title:f.layerId,removable:d,data:{order:b.length-g}};l.title=k.title;h.push(l)}}f=[];for(g=0;g<h.length;g++)if(l=h[g],k=this.getLayerMetaData(l.id)){var n=k.layer;if(n)for(k=n.length-1;0<=k;k--){var m=n[k];m.layer&&0!==m.layer.length&&(m={parent:l.id,id:m.id,title:m.title,removable:d,data:{order:this.getLayerExportData(m.id).layerPos}},f.push(m))}else console.error("sub folder without children",l.id)}else console.error("no metadata found for sub folder",
l.id);for(g=0;g<f.length;g++)h.push(f[g]);for(g=0;g<h.length;g++)if(l=h[g],k=this.getLayerMetaData(l.id))if(n=k.layer)for(k=n.length-1;0<=k;k--){if(m=n[k],!(m.layer&&0<m.layer.length)){var q=this.getLayerExportData(m.id);if(f=m.bbox){f=f.split(",");for(var p=0;p<f.length;p++)f[p]=Number.parseFloat(f[p])}f={folder:l.id,id:m.id,title:m.title,active:q.active,query:1===q.layerQueryable,transparency:1-.01*q.opacity,type:netgis.LayerTypes.WMS,url:this.getLayerMapURL(m.id),name:m.name,format:"image/png",
bbox:f,removable:d,data:{order:this.getLayerExportData(m.id).layerPos}};a.push(f)}}else console.error("layer folder without children",l.id);else console.error("no metadata found for layer folder",l.id);var t=this;a.sort(function(a,b){b=b.id;a=t.getLayerExportData(a.id);b=t.getLayerExportData(b);a=a.layerPos;b=b.layerPos;if(c.layers_inverse){if(a<b)return 1;if(a>b)return-1}else{if(a<b)return-1;if(a>b)return 1}return 0});d=1E3+b.length;for(g=0;g<b.length;g++)for(h=b[g].layerId.toString(),k=0;k<a.length;k++)f=
a[k],f.id===h&&(f.order=d-g);return e};netgis.WMC.prototype.getLayerExportData=function(a){for(var b=this.exportData.layerList,c=0;c<b.length;c++){var d=b[c];if(d.layerId.toString()===a)return d}return null};netgis.WMC.prototype.getLayerMetaData=function(a,b){b||(b=this.metaData.wms.srv);for(var c=0;c<b.length;c++){var d=b[c];if(d.layer){var e=this.getLayerMetaData(a,d.layer);if(e)return e}if(d.id===a)return d}return null};
netgis.WMC.prototype.getLayerMapURL=function(a,b,c){b||(b=this.metaData.wms.srv);for(var d=0;d<b.length;d++){var e=b[d];e.getMapUrl&&""!==e.getMapUrl&&(c=e.getMapUrl);if(e.layer){var f=this.getLayerMapURL(a,e.layer,c);if(f)return f}if(e.id===a)return c}return null};
...
netgis.WMC.prototype.parseServiceLayer=function(a,b,c,d,e){var f=b.bbox;if(f){f=f.split(",");for(var g=0;g<f.length;g++)f[g]=Number.parseFloat(f[g])}return{id:a,folder:c,title:d.title,active:e?e.active:!0,query:1===d.queryable,transparency:e?1-.01*e.opacity:0,order:1E3,type:netgis.LayerTypes.WMS,url:b.getMapUrl,name:d.name,format:e?e.currentFormat:"image/png",bbox:f,removable:this.config&&this.config.wmc&&!0===this.config.wmc.layers_removable?!0:!1}};
...
q=null;if(b)for(var p=0;p<b.length;p++)if(b[p].layerId.toString()===m){q=b[p];break}n=this.parseServiceLayer(m,f,h.id,n,q);d.push(n)}}}return{folders:c,layers:d}};netgis=netgis||{};netgis.WMCLegacy=function(a){this.config=a;this.output={extent:null,entities:[]}};netgis.WMCLegacy.Config={legacy_mode:!0,url:"",layers_url:"",layers_removable:!1};netgis.WMCLegacy.prototype.requestContext=function(a,b){this.callback=b;netgis.util.request(a,this.onContextResponse.bind(this))};
netgis.WMCLegacy.prototype.onContextResponse=function(a){if(netgis.util.isJSON(a)){a=JSON.parse(a);console.info("WMC RESPONSE:",a);var b=a.wmc.bbox;if(b&&""!==b&&",,,"!==b){b=b.split(",");for(var c=0;c<b.length;c++)b[c]=Number.parseFloat(b[c]);!a.wmc.crs||"string"===typeof a.wmc.crs||a.wmc.crs instanceof String||(a.wmc.crs=a.wmc.crs[0]);if(a.wmc.crs&&a.wmc.crs!==this.config.map.projection){c=proj4(a.wmc.crs,this.config.map.projection,[b[0],b[1]]);var d=proj4(a.wmc.crs,this.config.map.projection,[b[2],
b[3]]);b[0]=c[0];b[1]=c[1];b[2]=d[0];b[3]=d[1]}this.output.extent=[b[0],b[1],b[2],b[3]]}(b=a.wmc.kmloverlay)&&0<b.length&&this.output.entities.push({layer:{id:"kml"},title:"KML",kml:b,active:!0});b=[];if(a.layerList)for(c=0;c<a.layerList.length;c++)d=a.layerList[c],b.push(d.layerId),this.output.entities.push({layer:{id:Number.parseInt(d.layerId)},position:d.layerPos,active:d.active,opacity:d.opacity?.01*Number.parseFloat(d.opacity):1});this.requestLayers(b)}else console.error("could not parse WMC response:",
a),this.callback&&this.callback({config:null,output:{}})};netgis.WMCLegacy.prototype.requestLayers=function(a){console.info("WMC REQUEST LAYERS:",a);var b=this.config.wmc;b?(b=b.layers_url,b=netgis.util.replace(b,"{ids}",a.join(",")),netgis.util.request(b,this.onLayersResponse.bind(this))):console.error("no config[ 'wmc' ] found, skipping WMC layer loading")};
netgis.WMCLegacy.prototype.onLayersResponse=function(a){a=JSON.parse(a);for(var b=a.wms.srv,c=0;c<b.length;c++){var d=b[c],e=this.createService(d);for(a=0;a<d.layer.length;a++){var f=d.layer[a],g=this.createLayer(f,e);if(f.layer)for(var h=0;h<f.layer.length;h++){var k=f.layer[h],l=this.createLayer(k,g);if(k.layer)for(var n=0;n<k.layer.length;n++){var m=k.layer[n],q=this.createLayer(m,l,!0);if(m.layer)for(var p=0;p<m.layer.length;p++)this.createLayer(m.layer[p],q,!0)}}}}for(a=0;a<this.output.entities.length;a++)b=
this.output.entities[a],b.layer&&(b.order=this.output.entities.length-1);this.callback&&this.callback({config:this.toConfig(),output:this.output})};netgis.WMCLegacy.prototype.find=function(a,b,c){return this.output.entities.filter(this.findFilter(a,b,c))};netgis.WMCLegacy.prototype.findFilter=function(a,b,c){return function(d){return(d=d[a])&&d[b]===c?!0:!1}};
netgis.WMCLegacy.prototype.createLayer=function(a,b,c){var d=Number.parseInt(a.id),e=this.find("layer","id",d)[0];e||(e={layer:{id:d}},c?this.output.entities.unshift(e):this.output.entities.push(e));e.title=a.title;e.name=a.name;e.parent=b;a.getLegendGraphicUrl&&a.getLegendGraphicUrlFormat&&(e.legend={url:a.getLegendGraphicUrl,format:a.getLegendGraphicUrlFormat});a.legendUrl&&(e.legend={url:window.decodeURIComponent(a.legendUrl),format:a.getLegendGraphicUrlFormat});if(1===a.layerQueryable||1===a.queryable)e.queryable=
!0;if(a.bbox){a=a.bbox.split(",");for(b=0;b<a.length;b++)a[b]=Number.parseFloat(a[b]);e.extent=[a[0],a[1],a[2],a[3]]}return e};netgis.WMCLegacy.prototype.createService=function(a,b){return{service:{id:a.id},title:a.title,url:a.getMapUrl}};netgis.WMCLegacy.prototype.toConfig=function(){};netgis=netgis||{};
...
{url:e,format:f}}c=c.getElementsByTagName("GetFeatureInfo");if(0<c.length){c=c[0];e=null;f=c.getElementsByTagName("Get");0<f.length&&(e=f[0].getElementsByTagName("OnlineResource")[0].getAttribute("xlink:href"));f=[];d=c.getElementsByTagName("Format");for(g=0;g<d.length;g++)f.push(d[g].innerHTML);b.requests.info={url:e,format:f}}}e=a.getElementsByTagName("Layer");for(c=0;c<e.length;c++)f=e[c],f.parentNode===a&&b.layers.push(this.parseLayer(f,!0));return b},parseLayer:function(a,b){var c=null,d=this.getChild(a,
"DataURL");d&&(d=this.getChild(d,"OnlineResource"))&&(c=d.getAttribute("xlink:href").split("id=")[1]);d=this.getChildString(a,"Name");var e=this.getChildString(a,"Title"),f=this.getChildString(a,"Abstract"),g="1"===a.getAttribute("queryable"),h=this.getChild(a,"LatLonBoundingBox");h&&(h=[Number.parseFloat(h.getAttribute("minx")),Number.parseFloat(h.getAttribute("miny")),Number.parseFloat(h.getAttribute("maxx")),Number.parseFloat(h.getAttribute("maxy"))]);var k=a.getElementsByTagName("LegendURL");
0<k.length?(k=k[0].getElementsByTagName("OnlineResource"),k=0<k.length?k[0].getAttribute("xlink:href"):null):k=null;c={id:c,name:d,title:e,abstract:f,queryable:g,bounds:h,legend:k,children:[]};if(b)for(b=a.getElementsByTagName("Layer"),d=0;d<b.length;d++)e=b[d],e.parentNode===a&&c.children.push(this.parseLayer(e,!0));return c},getChild:function(a,b){b=a.getElementsByTagName(b);if(0===b.length)return null;b=b[0];return b.parentNode!==a?null:b},getChildString:function(a,b){return(a=this.getChild(a,
b))?a.innerHTML:null},buildRequestURL:function(a,b){var c=netgis.util.parseURL(a,!0);a=c.base;c=c.parameters;for(var d in c)"service"===d.toLowerCase()&&delete c[d],"request"===d.toLowerCase()&&delete c[d];c.service="WMS";c.request=b;b=[];for(d in c)b.push(d+"="+c[d]);return a+"?"+b.join("&")}};
netgis.build="20260925"; 
