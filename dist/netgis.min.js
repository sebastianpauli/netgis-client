...
netgis.Import.prototype.onGeoportalFolderResponse=function(a,b){a.getElementsByTagName("ul")[0].innerHTML="";a.getElementsByTagName("input")[0].removeAttribute("disabled");b=netgis.WMS.parseCapabilities(b);console.info("IMPORT CAPS:",b);var c=!0;this.config["import"]&&!1===this.config["import"].geoportal_order_reverse&&(c=!1);this.createGeoportalLayers(a,b,b.layers,!0,c);this.config["import"]&&!0===this.config["import"].geoportal_simplify_folders&&this.simplifyGeoportalFolder(a);b=!1;this.config["import"]&&
!0===this.config["import"].geoportal_order_by_meta&&(b=!0);if(b){b=[];var d=this.geoportalData.data.wms.srv;for(c=0;c<d.length;c++){b.push(d[c].title);var e=d[c].layer;if(e)for(var f=0;f<e.length;f++){b.push(e[f].title);var g=e[f].layer;if(g)for(var h=0;h<g.length;h++)b.push(g[h].title)}}d=a.getElementsByTagName("li");for(c=0;c<d.length;c++)e=d[c],f=b.indexOf(e.innerText),e.setAttribute("data-order",f);this.geoportalResults.reorderByAttribute("data-order",!1,!0,a.getElementsByTagName("ul")[0])}};
...
netgis.WMC.prototype.getLayerMapURL=function(a,b,c){b||(b=this.metaData.wms.srv);for(var d=0;d<b.length;d++){var e=b[d];e.getMapUrl&&""!==e.getMapUrl&&(c=e.getMapUrl);if(e.layer){var f=this.getLayerMapURL(a,e.layer,c);if(f)return f}if(e.id===a)return c}return null};netgis=netgis||{};netgis.WMCLegacy=function(a){this.config=a;this.output={extent:null,entities:[]}};netgis.WMCLegacy.Config={legacy_mode:!0,url:"",layers_url:"",layers_removable:!1};netgis.WMCLegacy.prototype.requestContext=function(a,b){this.callback=b;netgis.util.request(a,this.onContextResponse.bind(this))};
