...
this.setPadding(0,0,0,0);this.setMode(netgis.Modes.VIEW)};
...
this.mode===netgis.Modes.DRAW_LINES&&(e=!1);this.mode===netgis.Modes.DRAW_POLYGONS&&(e=!1);this.mode===netgis.Modes.CUT_FEATURES_DRAW&&(e=!1);e&&(0<c.length&&!1===this.selectMultiple&&(this.selectedFeatures=[]),0===c.length&&!1===this.selectMultiple&&(this.selectedFeatures=[]),this.mode===netgis.Modes.BUFFER_FEATURES_DYNAMIC&&this.updateBufferFeaturesSketch(this.bufferFeaturesRadius,this.bufferFeaturesSegments));for(var f=0;f<c.length;f++){var g=c[f];if(e){var h=this.selectedFeatures.indexOf(g.feature);
-1<h?this.selectedFeatures.splice(h,1):this.selectedFeatures.push(g.feature)}this.onFeatureClick(g.feature,g.layer,b,a)}e={resolution:this.view.getResolution(),projection:this.view.getProjection().getCode(),bbox:this.view.calculateExtent(this.map.getSize()),width:this.map.getSize()[0],height:this.map.getSize()[1]};f=ol.proj.toLonLat(a,this.view.getProjection());b={mode:this.mode,pixel:b,coords:a,lon:f[0],lat:f[1],overlay:this.popupOverlay.getElement(),view:e};netgis.util.invoke(this.container,netgis.Events.MAP_CLICK,
b);this.redrawVectorLayers()};netgis.Map.prototype.onContainerClick=function(a){if(2===a.detail)this.onDoubleClick(a)};
...
netgis.Toolbox.prototype.onBottomHeaderClick=function(a){netgis.util.invoke(this.panel.container,netgis.Events.CLIENT_SET_MODE,{mode:netgis.Modes.VIEW})};netgis.Toolbox.prototype.onButtonClick=function(a){a=a.currentTarget;var b=a.getAttribute("data-id");netgis.util.invoke(a,netgis.Events.TOOLBOX_BUTTON_CLICK,{id:b});netgis.Client.handleCommand(a,b)};
