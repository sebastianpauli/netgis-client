...
netgis.Import.prototype.onGeoportalFolderResponse=function(a,b){a.getElementsByTagName("ul")[0].innerHTML="";a.getElementsByTagName("input")[0].removeAttribute("disabled");b=netgis.WMS.parseCapabilities(b);this.createGeoportalLayers(a,b,b.layers,!0);this.config["import"]&&!0===this.config["import"].geoportal_simplify_folders&&this.simplifyGeoportalFolder(a);b=[];for(var c=this.geoportalData.data.wms.srv,d=0;d<c.length;d++){b.push(c[d].title);var e=c[d].layer;if(e)for(var f=0;f<e.length;f++){b.push(e[f].title);
var g=e[f].layer;if(g)for(var h=0;h<g.length;h++)b.push(g[h].title)}}c=a.getElementsByTagName("li");for(d=0;d<c.length;d++)e=c[d],f=b.indexOf(e.innerText),e.setAttribute("data-order",f);this.geoportalResults.reorderByAttribute("data-order",!1,!0,a.getElementsByTagName("ul")[0])};
...
this.geoportalResults.addCheckbox(a,m,n.title,!1,!1,null,this.config["import"].clip_titles),m.setAttribute("title",n.abstract),m=m.getElementsByTagName("input")[0],m.setAttribute("data-map-url",f),m.setAttribute("data-info-url",g),m.setAttribute("data-map-format",h),m.setAttribute("data-info-format",k),m.setAttribute("data-name",n.name),m.setAttribute("data-title",n.title),m.setAttribute("data-queryable",n.queryable)):(m=this.geoportalResults.addFolder(a,m,n.title,!1,!1,!1,!1,this.config["import"].clip_titles),
m.setAttribute("title",n.abstract),m.setAttribute("data-title",n.title),d&&this.createGeoportalLayers(m,b,n.children,!0))}};
...
netgis.Import.prototype.onGeoportalSubmitDynamic=function(a){var b=0,c=!1;this.config["import"]&&!0===this.config["import"].geoportal_import_hierarchy&&(c=!0);var d=this.geoportalResults.container.getElementsByTagName("li");for(a=0;a<d.length;a++){var e=d[a],f=e.getElementsByTagName("input")[0];if(f.checked){b+=1;var g=null,h=e.parentNode;h.classList.contains("netgis-tree")||(h=e.parentNode,g="geoportal_"+h.parentNode.parentNode.getAttribute("data-id"));if(e.classList.contains("netgis-folder"))f=
e.getAttribute("data-id"),f="geoportal_"+f,h=e.getAttribute("data-title"),e=e.getElementsByTagName("details")[0].hasAttribute("open"),g={folder:{parent:c?g:null,id:f,title:h,open:e}},netgis.util.invoke(this.sections.geoportal,netgis.Events.IMPORT_GEOPORTAL_SUBMIT,g);else if(e.classList.contains("netgis-item")){e=f.getAttribute("data-id");e="geoportal_"+e;h=f.getAttribute("data-title");var k=f.getAttribute("data-map-url");f=f.getAttribute("data-name");g={layer:{folder:g,id:e,url:k,name:f,title:h}};
netgis.util.invoke(this.sections.geoportal,netgis.Events.IMPORT_GEOPORTAL_SUBMIT,g)}}}if(0<b){this.modal.hide();b=this.geoportalResults.container.getElementsByTagName("input");for(a=0;a<b.length;a++)b[a].checked=!1;this.geoportalResults.updateFolderChecks();this.onGeoportalTreeItemChange()}};
