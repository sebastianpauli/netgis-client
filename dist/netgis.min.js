...
netgis.Client.prototype.onContextResponseLayer=function(a){a=JSON.parse(a);var b=a.wms.srv;if(b&&0!==b.length)if(a=b[0],a.layer&&1===a.layer.length){if(b=a.layer[0],!0===b.isRoot){var c=b.getCapabilitiesUrl+"&withChilds=1",d=this.modules.import,e=this.modules.layertree,f="root_"+b.id,g=e.tree.addFolder(null,f,b.title,!0,!1,!0,!0,this.config.layertree.clip_titles);g.setAttribute("title",b["abstract"]);g.setAttribute("data-title",b.title);g.setAttribute("data-root-id",a.wmsRootLayerId);g.setAttribute("data-url",
